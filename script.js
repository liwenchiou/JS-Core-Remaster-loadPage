const dialogueData = [
  ...
  {
    speaker: "傳奇導師 Liwen",
    text: "<b>第一步：每日任務書</b>。每天，我都會在 <a href='https://ithelp.ithome.com.tw/users/20105113/ironman/9064' target='_blank'>iThome 鐵人賽平台</a> 與 <a href='https://garden.liwen.studio/docs/learning/js-core-remaster' target='_blank'>數位花園部落格</a> 同步發布新的任務內容，那是你的指引。",
    action: () => {},
  },
  {
    speaker: "傳奇導師 Liwen",
